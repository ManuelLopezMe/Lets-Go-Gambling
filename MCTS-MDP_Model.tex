...
Each hand is played optimally with <span class="math-inline">σ\-1</span> remaining splits. Since you now have 2 hands, their expected values are added together.
\end{enumerate}
